...
The quality of the priors constructed from fishprior is largely dependent on the data extracted from FishBase, which may be uneven across species, traits, and geographic regions. Users should therefore carefully check the amount and quality of available information and conduct sensitivity analyses when trait data are sparse. fishprior currently supports normal and lognormal distribution summaries, future package development will expand available distributions and available traits. 
