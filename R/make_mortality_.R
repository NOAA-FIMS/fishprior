...
#'
#' @param data A data frame returned by [summarize_fishbase_traits()] containing
...
#'
#' @details
#' The Hamel--Cope prior is based on the assumption that natural mortality
#' follows a lognormal distribution. The mean of the lognormal distribution is
