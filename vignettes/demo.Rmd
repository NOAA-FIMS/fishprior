...
This data can be summarized to provide output similar to what is returned from FishLife. Only a handful of traits are currently summarized but more can be provided in the future should it be desired. Feel free to fill out a [GitHub Issue](https://github.com/NOAA-FIMS/fishprior) if you would like to see more traits summarized.
